...
exports.retornarTodasLasPolizas = function(){
	return poliza;
};

exports.retornarPolizasVigentesPorID = function(cedula){
	recuperarPolizasVigentes(cedula);
	return arrayPolizasVigentes;
};

exports.retonarPolizaVPorID = function(numeroPoliza){
	for(var i = 0; i< poliza.length; i++){
		if(poliza[i].idPoliza == numeroPoliza){
			return poliza[i];
		}
	}
	return null;
...
exports.retonarJsonPolizasVigentes = function(cedula){
	recuperarPolizasVigentes(cedula);
